...
<body class="bg-slate-100 min-h-screen py-8 px-3 sm:px-6">
  ...
  <!-- BẢNG ĐIỀU KHIỂN CHÍNH (ADMIN DASHBOARD) - TRUY CẬP TRỰC TIẾP KHÔNG CẦN MẬT KHẨU -->
  ...
  <script>
    ...
    // TỰ ĐỘNG KHỞI TẠO DASHBOARD TRỰC TIẾP (KHÔNG CẦN MẬT KHẨU)
